...
public static class DbInitializer
    {
        public static void Initialize(TemplateDbContext context)
        {
            ...
            new Enrollment{Student=students[0],Course=courses[2],Grade=Grade.C},
            new Enrollment{Student=students[0],Course=courses[3],Grade=Grade.B},
            new Enrollment{Student=students[1],Course=courses[1],Grade=Grade.B},
            ...
            new Enrollment{Student=students[3],Course=courses[2],Grade=Grade.F},
            new Enrollment{Student=students[4],Course=courses[3],Grade=Grade.C},
